...
<div class="content-header">
  ...
  <div class="container-fluid">
	<div class="row">
	  ...
	  <div class="col-sm-6">
		<h1 class="m-0">Macros Management</h1>
		<ol class="breadcrumb float-sm-left mt-2">
			<button 
				...
				data-openmodallabel="Add Macro"
				data-openmodalbody="#addeditcontent"
				data-backendurl="backend/bk_macromanagement.php"
				data-backendrequest="addmacro">
			  Add Macro <i class="fa-solid fa-plus"></i>
			</button>
		</ol>
	  </div>
        ...
        <div class="row">
            ...
            <div class="card" style="border:2px solid black;">
              <div class="card-header">
                <h3 class="card-title">List of Macros</h3>
...
<script>
  TableLoader.load({
    tableId: "#tblviewmacros",
    url: "backend/bk_macromanagement.php",
    request: { request: "viewmacros" }
  });
