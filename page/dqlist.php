...
<body class="hold-transition sidebar-mini theme-green">
            ...
            <div class="">
                <div class="card border border-success">
                    <div class="card-header bg-success">
                        <h5 class="mb-0 titleselect">Selection Line Up: Position List</h5>
                    </div>
	...
	var currentPosId = "";
        DivLoader(
            ...
            'backend/bk_dqlist.php', {
                request: 'fetchpositions',
                RID: UserInfo["RID"]
            }
        );

	$(document).off('change', '.selectcategory').on('change',  '.selectcategory', function(e) {
		var value = $(this).val();
		var text = $(this).find("option:selected").text();
  
		$(".titleselect").html("Selection Line Up: Position List of " + text);
		 DivLoader(
            'positionstableloader',
            'backend/bk_dqlist.php', {
                request: 'fetchpositions',
