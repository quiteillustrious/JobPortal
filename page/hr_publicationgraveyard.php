...
function loadPublications() {
    ...
    $.ajax({
        url: 'backend/bk_hrclosedpublications.php',
        method: 'POST',
        data: {
                ...
                <div class="col-md-4 d-flex">
                    <div class="card card-outline card-success flex-fill d-flex flex-column">
                        ...
                        <div class="card-footer text-center">
                            ...
                            <button class="btn btn-sm btn-info add-position" 
                                    id="republish_publication"
                                    data-datavalue="${pub.publication_id}"
                                    data-backendurl="backend/bk_hrclosedpublications.php"
                                    data-backendrequest="republishpublication"
                                    >
                                <i class="fa-solid fa-newspaper"></i> Republish Publication
                            </button>
                        </div>
...
$(document).off('click', '#republish_publication').on('click', '#republish_publication', function(e) {
    ...
    Swal.fire({
        title: "Are you sure?",
        text: "This publication will be republished.",
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#d33",
        cancelButtonColor: "#6c757d",
