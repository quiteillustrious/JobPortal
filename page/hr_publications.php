...
<section class="content-header">
    ...
    <div class="col-sm-6">
        <button class="btn btn-success"
            ...
            data-backendrequest="addpublication"
            data-openmodal="#addeditmodal"
            data-openmodallabel="Add Publication"
                    ...
                    <div class="card card-outline card-success flex-fill d-flex flex-column">
                        ...
                        <div class="card-footer text-center">
                            ...
                            <button class="btn btn-sm btn-info add-position"
                                    id="publish_publication"
                                    data-datavalue="${pub.publication_id}"
                                    data-backendurl="backend/bk_hrpublications.php"
                                    data-backendrequest="publishpublication"
                                    >
                                <i class="fa-solid fa-newspaper"></i> Publish
                            </button>
                        </div>
